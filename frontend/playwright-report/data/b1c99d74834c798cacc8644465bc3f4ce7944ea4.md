...
- Name: contract-modal.spec.ts >> ContractModal — alquiler (medium risk) >> shows ANALYSE history entry
- Location: e2e/contract-modal.spec.ts:91:3
...
Call log:
  - waiting for locator('tr').filter({ has: getByText('contrato_alquiler_madrid.txt') }).getByRole('button', { name: 'View' })
...
- generic [ref=e3]:
  - generic [ref=e4]:
    - textbox "Enter username…" [ref=e5]
    - button "Set user" [ref=e6]
    - generic [ref=e7]:
      - button "Upload contract" [disabled]
  - generic [ref=e8]:
    - generic [ref=e9]:
      - heading "Contracts" [level=2] [ref=e10]
      - button "Refresh" [ref=e11]
    - paragraph [ref=e12]: "Failed to load contracts: Error 404"
    - table [ref=e15]:
      - rowgroup [ref=e16]:
        - row "Filename Type Status Risk Uploaded by Last updated" [ref=e17]:
          - columnheader "Filename" [ref=e18]
          - columnheader "Type" [ref=e19]
          - columnheader "Status" [ref=e20]
          - columnheader "Risk" [ref=e21]
          - columnheader "Uploaded by" [ref=e22]
          - columnheader "Last updated" [ref=e23]
          - columnheader [ref=e24]
      - rowgroup [ref=e25]:
        - row "No contracts found." [ref=e26]:
          - cell "No contracts found." [ref=e27]
```
